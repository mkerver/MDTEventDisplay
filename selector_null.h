...
// Mon Feb 13 10:57:53 2012 by ROOT version 5.28/00a
// from TTree Segments/My first tree
// found on file: user.ediehl.00191920.physics_Muons.reco.UM1821.NO_TS.UM1821.ZMUMU.EXT0._00003.CalibrationNtuple.root
//////////////////////////////////////////////////////////
...
public :
   ...
   //   Int_t           phi_nPhiHits;
   //   Int_t           phi_phiPatIndex[2500];   //[phi_nPhiHits]
   //   UInt_t          phi_id[2500];   //[phi_nPhiHits]
   //   Float_t         phi_posX[2500];   //[phi_nPhiHits]
   //   Float_t         phi_posY[2500];   //[phi_nPhiHits]
   //   Float_t         phi_posZ[2500];   //[phi_nPhiHits]
   //   Float_t         phi_error[2500];   //[phi_nPhiHits]
   Int_t           trkHit_nHits;
   ...
   //   Int_t           trkHole_trackIndex[100];   //[trkHole_nHoles]
   //   UInt_t          trkHole_id[100];   //[trkHole_nHoles]
   //   Float_t         trkHole_posX[100];   //[trkHole_nHoles]
   //   Float_t         trkHole_posY[100];   //[trkHole_nHoles]
   //   Float_t         trkHole_posZ[100];   //[trkHole_nHoles]
   Int_t           trk_nTracks;
